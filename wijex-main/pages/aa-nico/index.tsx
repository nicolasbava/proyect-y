...
// IMPORT DATA
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/aa-nico/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/aa-nico/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        ...
        />
          ...
          <MapComponent locations={[-56.17261019999999,-34.8972512]} />
