...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/acabados-arquitectonicos-lisso/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/acabados-arquitectonicos-lisso/config-data'; //CAMBIAR DIRECCION
  ...
  return (
    <div>
      ...
      <Layout
        ...
        url={'acabados-arquitectonicos-lisso'}
      >
        <CoverPageTextButton
          name={PERSONAL_DATA.NAME}
          description={PERSONAL_DATA.DESCRIPTION}
