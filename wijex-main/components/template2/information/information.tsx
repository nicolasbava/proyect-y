                        ...
                        <div className="flex-col flex  self-center p-10 sm:max-w-6xl xl:max-w-3xl z-10">
                            ...
                            <div className="pt-6">
                                <button onClick={() => onResumeClick()}
                                    className="px-8 py-2 pt-3 leading-5 transition-colors duration-200 transform bg-t2secondary rounded-md hover:bg-t2secondary focus:outline-none focus:bg-t2secondary  shadow-lg"
                                    style={{ color: 'white' }}
                                >
                                    <h2 className="mx-auto justify text-base font-semibold leading-none tracking-wide text-t2primary title-font">
                                        {props.btnName}
                                    </h2>
                                </button>
                            </div>
