  ...
  return (
    ...
    <section id='home'> 
      <div className="mt-2 mb-16 sm:mt-0 sm:mb-0 md:flex md:flex-row md:-mt-8 lg:flex lg:flex-row lg:mt-10 h-auto">
        {/* IMAGE DIV */}
        <div className="flex flex-row px-10 pl-0 pt-48 mb-0 md:pt-32 lg:px-10 lg:pl-40 lg:pr-16 ">
          <div className=" flex flex-row content-end justify-end item-end">
            <img
              className='custom-h-50 transform translate-x-10 -translate-y-10 lg:translate-x-16 lg:-translate-y-16 w-full mg:w-8/12 lg:w-2/3 z-10 '
              style={{}}
        ...
        {/* H1 TITLE DIV */}
        <div className="absolute -mt-10 sm:-mt-40 w-full md:mt-96 sm:w-1/2 md:w-1/2 z-10 self-center ">
