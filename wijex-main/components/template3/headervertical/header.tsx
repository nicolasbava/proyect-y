        ...
        <div >
            ...
            <div className="fixed z-50 rounded-r lg:hidden flex justify-between w-full p-6 items-center bg-t4primary mb-1 h-auto">
                ...
                <div aria-label="toggler" className="flex justify-center items-center">
                    ...
                    <button aria-label="close" id="close" onClick={() => setShow(false)} className={`${show ? '' : 'hidden'} focus:outline-none focus:ring-2 text-t5t4fourth`}>
                        <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="Main" className={`${show ? '' : '-translate-x-full'} transform lg:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start h-full w-full base:w-64 flex-col ${styles.customHeader}`}>
                ...
                <div className={`${!show ? 'hidden' : ''} mt-8 flex flex-col space-x-3 lg:block lg:-translate-x-full`}>
                    ...
                    <div className='pl-2 mb-6' >
                        <button className='hover:bg-t4thirdy px-2 rounded-md'
                            onClick={() => {
                                var file = new Blob(
                        ...
                        >
                            <div className='flex flex-col items-center'>
                                ...
                                <div className='flex flex-col mt-2'>
                                    <text
                                        className="text-base  font-semibold leading-none title-font  text-t4fourth  text-center"
                                    >
                                        Descargar
                                    </text>
                                    <text
                                        className="text-base  font-semibold leading-none  title-font  text-t4fourth text-center mt-0.5"
                                    >
                                        Contacto
                                    </text>
                                </div>
                ...
                <>
                    ...
                    >
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            {/*content*/}
                            <div className="border-0 rounded-lg relative flex flex-col w-full bg-t4primary dark:bg-t4primary outline-none focus:outline-none">
                                {/*header*/}
